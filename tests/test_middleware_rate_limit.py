"""Tests for security middleware rate limiting and login lockout."""
...
def _middleware_with_fixed_ip() -> SecurityMiddleware:
    ...
    sm._get_client_ip = lambda: "203.0.113.10"  # noqa: SLF001
    return sm
...
def test_login_lockout_after_failed_attempts():
    ...
    limited, remaining = sm.is_login_locked_out("locked_user", max_attempts=5, window=300)

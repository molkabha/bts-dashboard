...
class Settings(BaseSettings):
    ...
    OUTPUTS_DIR: Path = Field(default=ROOT / "NB3" / "output")
    ...
    # Notebook Outputs
    NB1_OUTPUT: Path = Field(default=ROOT / "NB1" / "output")
    NB2_OUTPUT: Path = Field(default=ROOT / "NB2" / "output")
    NB3_OUTPUT: Path = Field(default=ROOT / "NB3" / "output")

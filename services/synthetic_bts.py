...
VALUE_COLS = [
    "consommation_kwh", "charge_cpu_pct", "temperature_ambiante", "score_qos",
    "trafic_data_mbps", "pue", "taux_charge_data", "taux_charge_voix",
    "puissance_emission_dbm", "vitesse_vent_ms", "humidite_relative_pct", "nb_secteurs_actifs",
]
...
def hourly_snapshot(
    ...
    *,
    ...
    for sid in station_ids:
        ...
        row: dict[str, Any] = {
            ...
            **ctx,
            ...
            "optimisation_qos_autorisee": int(float(base.get("score_qos") or 0.85) >= settings.QOS_SEUIL_DEFAULT),
        }
    ...
    if use_ml:
        ...
        if not enriched.empty and "conso_predite" in enriched.columns and enriched["conso_predite"].notna().any():
            out = enriched
